# LaravelSite
			<h4>		<p style="text-indent:30px">Для портфолио не только представление важно, но также важен и контент. Для моего портфолио как нельзя более кстати подходит проект по созданию веб приложения или веб сайта.  Поэтому, статья о том, как я создавал сайт портфолио и будет первым наполнением сайта.
