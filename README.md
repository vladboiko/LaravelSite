# LaravelSite
            ...
            Если у кого много времени, может изменить, отредактировать, дополнить, убрать, разместить, использовать в коммерческих или иных целях и т.д. без каких-либо ссылок, указаний и т.д. Безвозмездно! Но! Если вы заработает 1 000 000 долларов США или евро, то 1% нужно кому-нибудь отлать! ))) 
